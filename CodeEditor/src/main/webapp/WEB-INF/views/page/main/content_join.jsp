		...
		<div class="join_inner_box">
			<div class="join_id" id="email_duplicate">
				...
				<div class="duplicate_check">
					<input type="email" placeholder="이메일을 입력해주세요." value="dog@naver.com" required>
			...
			<div class="join_nick" id="nick_duplicate">
				닉네임
				<div class="duplicate_check">
					<input type="text" placeholder="닉네임을 입력해주세요." value="dog" required>
					<button type="button">중복체크</button>
				</div>
			...
			<div class="join_password">
				비밀번호 
				<input type="password" id ="password" placeholder="영문,숫자,특수문자 중 3종류 이상 조합하여 8~12자리" required>
			</div>
